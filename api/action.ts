...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const customProvider = new ethers.JsonRpcProvider('https://base-sepolia.core.chainstack.com/413dbef7cd2b4363a4e3fe589981df14');

    const wallet = new ethers.Wallet(
      FARCASTER_ATTESTOR,
      customProvider // ethers.getDefaultProvider('https://sepolia.base.org') // chainId: "eip155:84532",
    );
